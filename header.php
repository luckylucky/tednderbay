					...
					<div class="span7">
						...
						<?php $_head_callus = get_theme_mod('_head_callus', '+1-888-888-888');
							...
							<div class="topbar_info">
								<i class="fa fa-phone"></i><span class="head-phone"><?php _e('Call Us:','instaappointment-lite'); ?><a href="tel:<?php echo esc_attr($_head_callus); ?>"><?php echo esc_attr($_head_callus); ?></a></span>
							</div>
						<?php } ?>
